...
set SDC_PATH /extra_caravel_files
...
#read_verilog ./wrapped_hack_soc.v; 
#read_verilog ./multi_project_files/wrapped_wishbone_demo/wrapped_wishbone_demo.lvs.powered.v; 
#read_verilog ./user_project_wrapper.v;
read_verilog /extra_caravel_files/chip_io_PLACEHOLDER.v;
...
# read_spef -path mprj/wrapped_hack_soc_6 ./wrapped_hack_soc.spef;
# read_spef -path mprj/wrapped_wishbone_demo_13 ./multi_project_files/wrapped_wishbone_demo/wrapped_wishbone_demo.spef
# read_spef -path mprj ./user_project_wrapper.spef;
# read_spef -path padframe ./def/tmp/chip_io.spef;
...
read_sdc -echo $SDC_PATH/caravel.sdc;
